<?php
/**
 * Dawn Web Design functions and definitions
 *
...
if ( ! function_exists( 'dawn_web_design_setup' ) ) :
	/**
	 ...
	 */
	function dawn_web_design_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Dawn Web Design, use a find and replace
		 * to change 'dawn-web-design' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'dawn-web-design', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'dawn-web-design' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'dawn_web_design_custom_background_args', array(
...
add_action( 'after_setup_theme', 'dawn_web_design_setup' );
 ...
 */
function dawn_web_design_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'dawn_web_design_content_width', 640 );
}
add_action( 'after_setup_theme', 'dawn_web_design_content_width', 0 );
 ...
 */
function dawn_web_design_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'dawn-web-design' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'dawn-web-design' ),
...
add_action( 'widgets_init', 'dawn_web_design_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'dawn_web_design_scripts' );
